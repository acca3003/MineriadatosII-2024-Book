...
Cada **individuo o cromosoma** está formado por unos cuantos **genes**. Para nuestro caso vamos a establecer que los indiduos tienen un único cromosoma con una cierta cantida de genes. Estos genes los consideramos como la cantidad mínima de información que se puede transferir. Los genes se pueden agrupar en **características o rasgos** que nos podrían ayudar en la resolución de ciertos problemas. 
...
`Generar de forma aleatoria una población inicial aleatoria.`

`Cada individuo/cromosoma tiene sus propios genes.`
...
Un posible esquema que puede representar una posible implementación de algoritmos genéticos se muestra en la figura \ref{fig-esquema-genetico} .
