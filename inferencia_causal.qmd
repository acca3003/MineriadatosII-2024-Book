...
A menudo se suelen confundir la causalidad con la correlación, lo que nos puede llevar a un gran error. Si entramos a [este famoso sitio web](https://www.tylervigen.com/spurious-correlations) podremos disfrutar rápidamente de algunos gráficos muy cómicos, que parecen sugerir una relación fáctica entre variables realmente diferentes. Por ejemplo, este gráfico muestra simultáneamente la cantidad anual de bebés que fueron llamados como Stevie versus la cotización de Amazon:
