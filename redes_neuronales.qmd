...
En esta neurona nos encontramos que se realizan los siguientes cálculos: $$ z = \sum_{i=1}^{n}w_ix_i+b_i$$ $$\hat{y} = \delta (z)$$
...
Si nosotros tenemos nuestra muestra de datos que tiene $n$ variables $x=\{x_1,x_2,...,x_n\}$ de forma que $x_{n-2},x_{n-1},x_n$  son variables categóricas que tienen $k,l,m$ número de categorías respectivamente, tendremos finalmente las siguientes variables sólo numéricas:
...
**Nadam (Nesterov-accelerated Adaptive Moment Estimatio)** 
Combina Adam y NAG. 
